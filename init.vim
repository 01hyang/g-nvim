...
set statusline+=\ \ \ [%{&ff}/%Y]
set statusline+=\ \ \ %<%20.30(%{hostname()}蝧?:%{CurDir()}%)\
...
"let g:SuperTabContextDiscoverDiscovery = ["&completefunc:<Tab>"]
" }}}


" ------- YouCompleteMe {{{
"set completeopt-=preview
let g:ycm_register_as_syntastic_checker = 1			" 1
...
let g:multi_cursor_prev_key='<C-m>' "<C-p>: ctrlp
