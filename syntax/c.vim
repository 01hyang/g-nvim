...
" doxygen-like
syn region cCommentDoc start="/\*\*" end="\*/" contains=@cCommentGroup,cCommentString,cCharacter,cSpaceError
...
syn region cComment start="/\*\*\*" end="\*/" contains=@cCommentGroup,cCommentString,cCharacter,cSpaceError
...
hi def link cCommentDoc		cCommentL
